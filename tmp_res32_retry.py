...
LOG = Path('/mnt/data2/work/16g_wave_hold_baseline_probe_res32_retry.log')
SAMPLES = Path('/mnt/data2/work/16g_wave_hold_baseline_probe_res32_retry_samples.jsonl')
PORT = 31673
...
cmd = [
    ...
    '--served-model-name', 'Qwen3.5-35B-A3B-16g-wave-probe-res32_retry',
