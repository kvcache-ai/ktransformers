#!/bin/bash
# MESH 397B BF16 benchmark — packed bf16 格式（model.language_model.layers 前缀）
# 用法: run_mesh_397b_bf16.sh <CAP> <PORT> <CUDA_LIST>
# CAP: slot 容量 (128/192/256/480), 480=full
...
exec python -m sglang.launch_server \
  ...
  --kt-weight-path /mnt/data2/models/Qwen3.5-397B-A17B-TEXTONLY \
