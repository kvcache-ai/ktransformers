...
eval_decode "$DS3_GGUF_F16" llama.cpp_ds3_fp16
eval_decode "$DS3_GGUF_Q4_0" llama.cpp_ds3_int4
eval_decode "$DS2_GGUF_F16" llama.cpp_ds2_fp16
eval_decode "$DS2_GGUF_Q8_0" llama.cpp_ds2_int8
