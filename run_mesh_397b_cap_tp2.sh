#!/bin/bash
# MESH 397B AMXINT4 benchmark — 方案 A, tensor_parallel=2, RAID0 O_DIRECT
# 用法: run_mesh_397b_cap_tp2.sh <CAP> <PORT> <CUDA_LIST>
# CAP: slot 容量 (32/64/96/128/192/256/384/480), 480=full (512 - 32 GPU experts)
# GE=32, TP=2, cpuinfer=48 (每进程 48 AMX 线程匹配 48 物理核心)
CAP=$1
PORT=$2
CUDA=$3
...
exec python -m sglang.launch_server \
  ...
  --kt-weight-path /mnt/raid397_amxint4/Qwen3.5-397B-A17B-AMXINT4-NUMA2-MESH-FIXED/ \
