...
LOG = Path("/mnt/data2/work/tp4_probe.log")
SAMPLES = Path("/mnt/data2/work/tp4_probe_samples.jsonl")
PORT = 31674
...
for cmd in [
    "pkill -KILL -f 'sglang.launch_server.*31674|kt run /mnt/data2/models/Qwen3.5-35B-A3B --port 31674'",
]:
...
cmd = [
    ...
    "baseline",
    "--served-model-name",
    "Qwen3.5-35B-A3B-16g-wave-probe-tp4",
