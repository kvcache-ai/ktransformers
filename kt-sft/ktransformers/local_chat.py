...
if __name__ == "__main__":
    ...
    if IS_DEBUG == False:
        ...
        local_chat(
            ...
            optimize_config_path="ktransformers/optimize/optimize_rules/DeepSeek-V2-Lite-Chat-sft-route-moe-amx.yaml",
            is_sft=True,
            sft_data_path="/home/lpl/KT-SFT/test_adapter/western_train.json",
            # sft_data_path="test_adapter/western_train.json",
            # sft_data_path="test_adapter/500token_test.json",
            save_adapter_path="/mnt/data/lpl/test_adapter/KMoE_NEW_V2_WEST",
            use_adapter=False,
            use_adapter_path="/mnt/data/lpl/test_adapter/KMoE_V2_WEST/checkpoint-660",
            is_test_data=False,
