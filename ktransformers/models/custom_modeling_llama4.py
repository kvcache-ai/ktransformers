...
from ktransformers.models.modeling_llama4 import Llama4PreTrainedModel, Llama4TextModel
...
class KLlama4ForCausalLM(Llama4PreTrainedModel):
    ...
    def forward(
        ...
        with torch.cuda.stream(current_stream):
            ...
            for i, decode_layer in enumerate(self.model.layers):
                ...
                if i not in self.config.moe_layers:
                    hidden_states = decode_layer.feed_forward(hidden_states, num_tokens_tensors)
                else:
