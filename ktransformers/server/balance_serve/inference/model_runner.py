...
class ModelRunner:
    ...
    model: KDeepseekV3ForCausalLM  | KQwen2MoeForCausalLM | KLlama4ForCausalLM
    ...
    def model_attn_plan(self, batch, cuda_graph_idx=0):
        ...
        elif isinstance(self.model, KQwen2MoeForCausalLM) or isinstance(self.model, KLlama4ForCausalLM):
            self.model.flash_infer_attn_plan(batch, self.bsz_tensor_buf, self.num_tokens_tensor_buf,
    ...
    def warmup(self):
        ...
        for i in range(len(self.cuda_graphs)):
            ...
            if isinstance(self.model, KQwen2MoeForCausalLM) or isinstance(self.model, KLlama4ForCausalLM):
