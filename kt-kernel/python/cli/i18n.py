...
MESSAGES: dict[str, dict[str, str]] = {
    "en": {
        ...
        "quant_int4_desc": "INT4 (Recommended - smaller, faster)",
        "quant_int8_desc": "INT8 (Higher precision)",
    ...
    "zh": {
        ...
        "quant_int4_desc": "INT4（推荐 - 更小、更快）",
        "quant_int8_desc": "INT8（更高精度）",
