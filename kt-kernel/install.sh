...
MANUAL CONFIGURATION:
  ...
  CPUINFER_CPU_INSTRUCT   - CPU instruction set
                            Options: NATIVE, AVX512, AVX512VNNI, AVX512F, AVX2, FANCY
...
build_step() {
  ...
  case "$CPUINFER_CPU_INSTRUCT" in
    NATIVE|FANCY|AVX512|AVX512VNNI|AVX512F|AVX2)
      ;;
    *)
      echo "Error: Invalid CPUINFER_CPU_INSTRUCT='$CPUINFER_CPU_INSTRUCT'"
      echo "Must be one of: NATIVE, FANCY, AVX512, AVX512VNNI, AVX512F, AVX2"
      exit 1
      ;;
  esac
