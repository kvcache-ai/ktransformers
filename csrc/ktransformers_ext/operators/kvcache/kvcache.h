...
private:
  ...
  std::vector<std::vector<std::vector<std::vector<block_q4_0>>>> k_cache_q4; // [layer_num, kv_head_num, past_block_num,
                                                                             // block_len * (head_dim / QK_4)]
  std::vector<std::vector<std::vector<std::vector<block_q4_0>>>> v_cache_q4; // [layer_num, kv_head_num, past_block_num,
                                                                             // head_dim * (block_len / QK_4)]
  std::vector<std::vector<std::vector<std::vector<block_q8_0>>>> k_cache_q8; // [layer_num, kv_head_num, past_block_num,
                                                                             // block_len * (head_dim / QK_8)]
  std::vector<std::vector<std::vector<std::vector<block_q8_0>>>> v_cache_q8; // [layer_num, kv_head_num, past_block_num,
  ...
  std::vector<std::vector<std::vector<std::vector<ggml_fp16_t>>>> importance_; // [layer_num, past_block_num, block_len,
                                                                               // attention_head_num]
  ...
  std::vector<std::vector<std::vector<std::vector<int>>>> selected_blocks_history_kvhead_; // [layer_num // layer_step,
