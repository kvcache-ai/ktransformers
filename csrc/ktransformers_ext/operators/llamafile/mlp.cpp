...
MLP::MLP(MLPConfig config) {
  ...
  mem_requests.push_back(
      {(void **)&gate_input_, config_.group_max_len * config_.hidden_size *
  ...
  mem_requests.push_back(
      {(void **)&up_input_, config_.group_max_len * config_.hidden_size *
  ...
  mem_requests.push_back(
      {(void **)&intermediate_fp32_, sizeof(float) * config_.group_max_len * config_.intermediate_size});
  mem_requests.push_back(
      {(void **)&down_input_, config_.group_max_len * config_.intermediate_size *
