#!/bin/bash
# MESH 35B BF16 benchmark — 方案 A, tensor_parallel=2, RAID0 O_DIRECT (md398)
# CAP: slot 容量 (32/64/96/128/160/192/full), full=224 (256 experts - 32 GPU experts)
CAP=$1
PORT=$2
CUDA=$3
...
exec python -m sglang.launch_server \
  ...
  --kt-weight-path /mnt/raid_bf16/Qwen3.5-35B-A3B-BF16-MESH-ALIGNED/ \
